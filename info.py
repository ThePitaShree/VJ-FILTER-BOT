...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6330347502').split()] # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002312550219')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://TarunDixit:TarunDixit@cluster0.8xfhm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "TarunDixit")
